...
const locations = [
  {
    ...
    image: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=800&h=300&fit=crop&crop=center",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=800&h=300&fit=crop&crop=center",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Encontre a unidade mais próxima de você e agende seus exames com facilidade
          </motion.p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {locations.map((location, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
            >
              <div className="bg-white rounded-2xl border border-gray-200 hover:border-accent transition-all duration-300 overflow-hidden">
                {/* Unit Image */}
